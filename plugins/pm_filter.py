...
async def tts_command(client, message):
    if len(message.command) > 1:
        ...
        return await message.reply_text(
            "🔊 <b>ᴛᴇxᴛ ᴛᴏ sᴘᴇᴇᴄʜ</b>\n\nSend /tts followed by your text or reply to a message.\n\n<b>Example:</b> <code>/tts Hello, how are you?</code>",
            parse_mode=enums.ParseMode.HTML
        )
...
async def share_command(client, message):
    if len(message.command) > 1:
        ...
        return await message.reply_text(
            "📤 <b>sʜᴀʀᴇ ᴛᴇxᴛ</b>\n\nSend /share followed by your text or reply to a message.\n\n<b>Example:</b> <code>/share Check out this bot @Astro_AF_bot</code>",
            parse_mode=enums.ParseMode.HTML
        )
