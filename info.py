...
API_ID = int(environ.get('API_ID', '2506'))
API_HASH = environ.get('API_HASH', '4cbb616dea66bf8ea81c6bc57')
BOT_TOKEN = environ.get('BOT_TOKEN', "")
MULTI_TOKENS = environ.get("MULTI_TOKENS", "").split()


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://ibb.co/dJpcdK6d')).split()
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://athrv:ATHRV09124@cluster0.g7kbgvs.mongodb.net/astro?retryWrites=true&w=majority")
